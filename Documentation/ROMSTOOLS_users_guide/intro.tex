...
/usr/local/lib/. You can specify a different root directory using the following option :
'make install root\_directory'.\\
\end{itemize}

\item For install loadDAP library process in the same way as for the
installation of libDAP. By default the files are installed under
/usr/local/share/.
\end{itemize}
\end{itemize}
