...
version\footnote{http://myroms.org}), both written by Kate Hedström\footnote{Kate
  Hedström, University of Alaska Faibanks, Center for Arctic Region Supercomputing
  Center, University of Alaska Fairbanks, } \citep{hedstroem2009} \footnote{Many
  thanks to Kate Hedstroëm for this work.}. These documents are available on the
