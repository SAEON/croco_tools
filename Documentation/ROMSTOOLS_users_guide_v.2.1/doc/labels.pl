...
$key = q/fig:makeclimpiscesNO3/;
$external_labels{$key} = "$URL/" . q|doc.html|; 
$noresave{$key} = "$nosave";

$key = q/sec:2-ways-nesting/;
$external_labels{$key} = "$URL/" . q|doc.html|; 
$noresave{$key} = "$nosave";
...
$key = q/tab:cppkeyNesting/;
$external_labels{$key} = "$URL/" . q|doc.html|; 
$noresave{$key} = "$nosave";

$key = q/cite_hedstroem2009/;
$external_labels{$key} = "$URL/" . q|doc.html|; 
$noresave{$key} = "$nosave";

$key = q/cite_AumontNoticePisces05/;
$external_labels{$key} = "$URL/" . q|doc.html|; 
$noresave{$key} = "$nosave";
...
$key = q/sec:quikscat-daily-data/;
$external_latex_labels{$key} = q|1.8.2|; 
$noresave{$key} = "$nosave";
