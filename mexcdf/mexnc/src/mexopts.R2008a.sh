...
## vanilla netcdf-3 settings, glnx86
#          NETCDF="/home/johne/local/netcdf-3.6.3/glnx86"
#          CFLAGS="$CFLAGS -g -I${NETCDF}/include "
#          CLIBS="${NETCDF}/lib/libnetcdf.a $CLIBS "
### vanilla netcdf-3 settings, sol64
#          NETCDF="/home/johne/local/netcdf-3.6.3/sol64"
##          CFLAGS="$CFLAGS -g -I${NETCDF}/include "
#          CLIBS="${NETCDF}/lib/libnetcdf.a $CLIBS "
## vanilla netcdf-3 settings, maci
          NETCDF="/home/johne/local/netcdf-3.6.3/maci"
          CFLAGS="$CFLAGS -g -I${NETCDF}/include "
          CLIBS="${NETCDF}/lib/libnetcdf.a $CLIBS "
#
