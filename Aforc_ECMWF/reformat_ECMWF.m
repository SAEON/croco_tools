function reformat_ECMWF_daily(Ymin,Ymax,Mmin,Mmax,lonmin,lonmax,latmin,latmax,...
    ...
    for Y=Ymin:Ymax
        ...
        for M=mo_min:mo_max
            ...
            if k<=9   % sst(mask), t2m, sst, u10, v10, q, swh, mwd, pp1d
                ...
                var3  = extract_ECMWF(ifile3,fname,Y,M,':',i1min,i1max,i2min,i2max,i3min,i3max,jmin,jmax)/div;  %divide by 6h;
                var9  = extract_ECMWF(ifile9,fname,Y,M,':',i1min,i1max,i2min,i2max,i3min,i3max,jmin,jmax)/div;  %divide by 6h;
                var15 = extract_ECMWF(ifile15,fname,Y,M,':',i1min,i1max,i2min,i2max,i3min,i3max,jmin,jmax)/div; %divide by 6h;
                %
                nc3   = netcdf(ifile3);
