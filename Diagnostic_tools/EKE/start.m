...
addpath([mypath,'Diagnostic_tools/EKE'])
addpath([mypath,'Diagnostic_tools/Eddy_detect'])
addpath([mypath,'Diagnostic_tools/Eddy_detect/SOURCES'])
addpath([mypath,'Diagnostic_tools/KmKe'])
addpath([mypath,'Diagnostic_tools/Transport'])
