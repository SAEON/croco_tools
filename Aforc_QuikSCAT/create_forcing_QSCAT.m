...
nw{'uwnd'}.units = ncchar('m/s');
nw{'uwnd'}.units = 'm/s';

nw{'vwnd'} = ncdouble('sms_time', 'eta_rho', 'xi_rho');
nw{'vwnd'}.long_name = ncchar('10m u-wind component');
nw{'vwnd'}.long_name = 'v-wind';
nw{'vwnd'}.units = ncchar('m/s');
nw{'vwnd'}.units = 'm/s';

nw{'wspd'} = ncdouble('sms_time', 'eta_rho', 'xi_rho');
nw{'wspd'}.long_name = ncchar('10 mwind speed');
