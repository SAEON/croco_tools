function add_ini_doc(ininame,grdname,oaname,cycle);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%  function [longrd,latgrd,doc]=add_ini_doc(ininame,grdname,...
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
disp('Add_ini_doc: creating variable and attribute')
%
% open the grid file  
% 
nc=netcdf(grdname);
...
%
  disp(['Add_ini_doc: vertical interpolation'])
  var=squeeze(noa{'DOC'}(l1,:,:,:));
  if addsurf
    var=cat(1,var(1,:,:),var);
  end
  if addbot
  ...
  nc{'DOC'}(l,:,:,:)=ztosigma(flipdim(var,1),zroms,flipud(z));
end
close(nc);
close(noa);
return
