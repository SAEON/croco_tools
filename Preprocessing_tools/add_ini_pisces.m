...
nc{'PO4'}.units = ncchar('mMol N m-3');
nc{'PO4'}.units = 'mMol N m-3';
%
%
nc{'Si'}.long_name = ncchar('Si');
nc{'Si'}.long_name = 'Si';
nc{'Si'}.units = ncchar('mMol N m-3');
nc{'Si'}.units = 'mMol N m-3';
%
%
nc{'O2'}.long_name = ncchar('O2');
nc{'O2'}.long_name = 'O2';
nc{'O2'}.units = ncchar('mMol N m-3');
nc{'O2'}.units = 'mMol N m-3';
%
%
nc{'DIC'}.long_name = ncchar('DIC');
nc{'DIC'}.long_name = 'DIC';
nc{'DIC'}.units = ncchar('mMol N m-3');
nc{'DIC'}.units = 'mMol N m-3';
%
%
nc{'TALK'}.long_name = ncchar('TALK');
nc{'TALK'}.long_name = 'TALK';
nc{'TALK'}.units = ncchar('mMol N m-3');
nc{'TALK'}.units = 'mMol N m-3';
%
%
