function add_ini_talk(ininame,grdname,oaname,cycle);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%  function [longrd,latgrd,talk]=add_ini_talk(ininame,grdname,...
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
disp('Add_ini_talk: creating variable and attribute')
%
% open the grid file  
% 
nc=netcdf(grdname);
...
%
  disp(['Add_ini_talk: vertical interpolation'])
  var=squeeze(noa{'TALK'}(l1,:,:,:));
  if addsurf
    var=cat(1,var(1,:,:),var);
  end
  if addbot
  ...
  nc{'TALK'}(l,:,:,:)=ztosigma(flipdim(var,1),zroms,flipud(z));
end
close(nc);
close(noa);
return
