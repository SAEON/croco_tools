function add_ini_dic(ininame,grdname,oaname,cycle);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%  function [longrd,latgrd,dic]=add_ini_dic(ininame,grdname,...
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
disp('Add_ini_dic: creating variable and attribute')
%
% open the grid file  
% 
nc=netcdf(grdname);
...
%
  disp(['Add_ini_dic: vertical interpolation'])
  var=squeeze(noa{'DIC'}(l1,:,:,:));
  if addsurf
    var=cat(1,var(1,:,:),var);
  end
  if addbot
  ...
  nc{'DIC'}(l,:,:,:)=ztosigma(flipdim(var,1),zroms,flipud(z));
end
close(nc);
close(noa);
return
