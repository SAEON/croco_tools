...
if (makeplot)
  ...
  figure
  test_clim(ininame,grdname,'SPHYTO',1,coastfileplot)
  figure
  test_clim(ininame,grdname,'LPHYTO',1,coastfileplot)
  figure
  test_clim(ininame,grdname,'SZOO',1,coastfileplot)
  figure
  test_clim(ininame,grdname,'LZOO',1,coastfileplot)
end 
